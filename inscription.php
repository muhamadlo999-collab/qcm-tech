...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erreurs)) {
        // Prépare une requête pour chercher si l'email existe déjà
...
<div class="auth-page">
    ...
    <div class="auth-card">
        ...
        <div class="auth-header">
            <!-- Icône affichée en haut du formulaire -->
        ...
        <form method="POST" class="auth-form" novalidate>
            ...
            <div class="form-row">
                <!-- Groupe du champ prénom, avec une classe d'erreur si besoin -->
                ...
                <!-- Groupe du champ nom, avec une classe d'erreur si besoin -->
            ...
            <!-- Groupe du champ email, avec une classe d'erreur si besoin -->
            ...
            <!-- Groupe du champ mot de passe, avec une classe d'erreur si besoin -->
            ...
            <!-- Groupe du champ confirmation du mot de passe, avec une classe d'erreur si besoin -->
            <div class="form-group <?= isset($erreurs['mdp_conf']) ? 'error' : '' ?>">
                <!-- Label du champ confirmation -->
